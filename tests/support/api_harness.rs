...
pub async fn build_state(pool: PgPool) -> (ApiState, String) {
...
pub async fn response_json(resp: impl IntoResponse) -> (StatusCode, serde_json::Value) {
...
pub fn string_field<'a>(value: &'a serde_json::Value, key: &str) -> &'a str {
    value
        .get(key)
